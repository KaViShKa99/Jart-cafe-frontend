...
export const Admin = () => {
  ...
  const [imageLinksPreview, setImageLinksPreview] = useState([]);
  const [imageUploadedPreview, setImageUploadedPreview] = useState([]);
  ...
  const [expandedArtworkId, setExpandedArtworkId] = useState(null); // State to track expanded artwork id
